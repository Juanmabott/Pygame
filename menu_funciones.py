...
class Menu():
    def __init__(self):
        ...
        self.form_pedir_nombre=Form("seleccionar_nombre",self.window, 300 , self.window_height // 2 - 80, 200, 100, (0, 0, 0), (0, 0, 255), active=True,imagen = "C:/Users/botta/Documents/pyton/pygame/sources/fondos/background1-720.png")
        self.nombre_jugador=self.form_pedir_nombre.ingresar_nombre_jugador(self.window)
        self.window.blit( self.fondo, (0, 0))
        form1 = Form("jugar",self.window, 300 , self.window_height // 2 - 80, 200, 100, (0, 0, 0), (0, 0, 255), active=True,imagen = "C:/Users/botta/Documents/pyton/pygame/sources/menu/letras blancas/menu principal/jugar.jpg")
        form2 = Form("opciones",self.window, 300 , self.window_height // 2, 200, 80, (0, 0, 0), (255, 0, 0), active=True,imagen = "C:/Users/botta/Documents/pyton/pygame/sources/menu/letras blancas/menu principal/opciones.jpg")
        form3 = Form("salir",self.window, 300, self.window_height // 2 + 155, 200, 80, (0, 0, 0), (0, 255, 0), active=True,imagen = "C:/Users/botta/Documents/pyton/pygame/sources/menu/letras blancas/menu principal/salir.jpg")
        form4 = Form("historia",self.window, 300, self.window_height // 2 + 75, 200, 80, (0, 0, 0), (0, 0, 0), active=True,imagen = "C:/Users/botta/Documents/pyton/pygame/sources/menu/letras blancas/menu principal/historiaBottom.jpg")

        self.formularios_menu= [form1, form2, form3,form4]
        ...
        self.form5 = [Form("salirhistoria",self.window, 300, self.window_height // 2 + 200, 200, 80, (0, 0, 0), (0, 255, 0), active=False,imagen = "C:/Users/botta/Documents/pyton/pygame/sources/menu/letras blancas/menu principal/salir.jpg")]
